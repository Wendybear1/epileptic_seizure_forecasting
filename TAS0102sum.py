...
csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/TAS0102/Cz_EEGauto_lag1_TAS0102_15s_3h.csv',sep=',',header=None)
...
print(t_window_arr[19440]);print(t_window_arr[20160]);
...
# pyplot.title('EEG variance in TAS0102',fontsize=13)
# pyplot.show()
var_arr=[]
...
for k in range(len(window_time_arr)):
    if window_time_arr[k]<51.4819444 and window_time_arr[k+1]>=51.4819444:
        seizure_timing_index.append(k)
    if window_time_arr[k]<57.2641667 and window_time_arr[k+1]>=57.2641667:
        seizure_timing_index.append(k)
    if window_time_arr[k]<75.1694444 and window_time_arr[k+1]>=75.1694444:
        seizure_timing_index.append(k)
    if window_time_arr[k]<81.3655556 and window_time_arr[k+1]>=81.3655556:
        seizure_timing_index.append(k)
    if window_time_arr[k]<116.407778 and window_time_arr[k+1]>=116.407778:
        seizure_timing_index.append(k)
    if window_time_arr[k]<145.771389 and window_time_arr[k+1]>=145.771389:
        seizure_timing_index.append(k)
print(seizure_timing_index)
index_ictal = seizure_timing_index


duration=[3,21,9,21,21,16]
...
np.savetxt("C:/Users/wxiong/Documents/PHD/combine_features/TAS0102_tags.csv", x, delimiter=",", fmt='%s')
...
# # pyplot.title('EEG variance in TAS0102',fontsize=15)
...
# # ax1.set_title('EEG variance in TAS0102',fontsize=15)
# # ax1.set_xlabel('Time(hour)',fontsize=15)
# # ax1.set_ylabel('Voltage ($\mathregular{v^2}$)',fontsize=15)
# # locs, labels = pyplot.xticks(fontsize=15)
# # locs, labels = pyplot.yticks(fontsize=15)
# # ax1.scatter(window_time_arr[12354],long_rhythm_var_arr[12354],s=40,c='k')
# # ax1.scatter(window_time_arr[13742],long_rhythm_var_arr[13742],s=40,c='k')
# # ax1.scatter(window_time_arr[18039],long_rhythm_var_arr[18039],s=40,c='k')
# # # ax1.scatter(window_time_arr[19526],long_rhythm_var_arr[19526],s=40,c='k')
# # # ax1.scatter(window_time_arr[27936],long_rhythm_var_arr[27936],s=40,c='k')
# # # ax1.scatter(window_time_arr[34984],long_rhythm_var_arr[34984],s=40,c='k')
...
# # locs, labels = pyplot.xticks(fontsize=15)
# # locs, labels = pyplot.yticks(fontsize=15)
# # ax2.scatter(window_time_arr[12354],phase_long_EEGvariance_arr[12354],s=40,c='k')
# # ax2.scatter(window_time_arr[13742],phase_long_EEGvariance_arr[13742],s=40,c='k')
# # ax2.scatter(window_time_arr[18039],phase_long_EEGvariance_arr[18039],s=40,c='k')
# # # ax2.scatter(window_time_arr[19526],phase_long_EEGvariance_arr[19526],s=40,c='k')
# # # ax2.scatter(window_time_arr[27936],phase_long_EEGvariance_arr[27936],s=40,c='k')
# # # ax2.scatter(window_time_arr[34984],phase_long_EEGvariance_arr[34984],s=40,c='k')
...
# # pyplot.xlabel('Time(hour)',fontsize=13)
# # pyplot.title('EEG autocorrelation in TAS0102',fontsize=13)
# # pyplot.show()
# value_arr=[]
...
# # pyplot.title('EEG autocorrelation in TAS0102',fontsize=15)
# # pyplot.xlabel('Time(hour)',fontsize=15)
...
# # ax2.set_title('EEG autocorrelation in TAS0102',fontsize=15)
# # ax2.set_xlabel('Time(hour)',fontsize=15)
# # locs, labels = pyplot.xticks(fontsize=15)
# # locs, labels = pyplot.yticks(fontsize=15)
# # ax2.scatter(window_time_arr[12354],long_rhythm_value_arr[12354],s=50,c='k')
# # ax2.scatter(window_time_arr[13742],long_rhythm_value_arr[13742],s=40,c='k')
# # ax2.scatter(window_time_arr[18039],long_rhythm_value_arr[18039],s=50,c='k')
# # # ax2.scatter(window_time_arr[19526],long_rhythm_value_arr[19526],s=50,c='k')
# # # ax2.scatter(window_time_arr[27936],long_rhythm_value_arr[27936],s=50,c='k')
# # # ax2.scatter(window_time_arr[34984],long_rhythm_value_arr[34984],s=40,c='k')
...
# # pyplot.hlines(0,window_time_arr[240*6],window_time_arr[-1],'k','dashed')
# # ax3.scatter(window_time_arr[12354],phase_long_EEGauto_arr[12354],s=50,c='k')
# # ax3.scatter(window_time_arr[13742],phase_long_EEGauto_arr[13742],s=40,c='k')
# # ax3.scatter(window_time_arr[18039],phase_long_EEGauto_arr[18039],s=50,c='k')
# # # ax3.scatter(window_time_arr[19526],phase_long_EEGauto_arr[19526],s=50,c='k')
# # # ax3.scatter(window_time_arr[27936],phase_long_EEGauto_arr[27936],s=50,c='k')
# # # ax3.scatter(window_time_arr[34984],phase_long_EEGauto_arr[34984],s=40,c='k')
# # ax3.set_xlabel('Time(hour)',fontsize=15)
# # locs, labels = pyplot.yticks([-0.5*np.pi,-0.25*np.pi,0,0.25*np.pi,0.5*np.pi],['-0.5$\pi$','Rising','0','Falling','0.5$\pi$'],rotation='vertical',fontsize=15)
# # pyplot.tight_layout()
# # pyplot.show()
...
#
#
# csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/TAS0102/RRI_ch31_timewindowarr_TAS0102_15s_3h.csv',sep=',',header=None)
...
# # pyplot.plot(window_time_arr,medium_rhythm_var_arr_4,'b',label='12 hour')
# # pyplot.plot(window_time_arr,long_rhythm_var_arr,'r',alpha=0.7,label='1 day')
# # pyplot.title('RRI variance in TAS0102',fontsize=15)
# # pyplot.xlabel('Time(hour)',fontsize=15)
...
# # ax1.set_title('RRI variance in TAS0102',fontsize=15)
# # ax1.set_xlabel('Time(hour)',fontsize=15)
# # ax1.set_ylabel('Second($\mathregular{s^2}$)',fontsize=15)
# # locs, labels = pyplot.xticks(fontsize=15)
# # locs, labels = pyplot.yticks(fontsize=15)
# # ax1.scatter(window_time_arr[12354],long_rhythm_var_arr[12354],c='k',s=40)
# # ax1.scatter(window_time_arr[13742],long_rhythm_var_arr[13742],c='k',s=40)
# # ax1.scatter(window_time_arr[18039],long_rhythm_var_arr[18039],c='k',s=40)
# # # ax1.scatter(window_time_arr[19526],long_rhythm_var_arr[19526],c='k',s=40)
# # # ax1.scatter(window_time_arr[27936],long_rhythm_var_arr[27936],c='k',s=40)
# # # ax1.scatter(window_time_arr[34984],long_rhythm_var_arr[34984],c='k',s=40)
# # # pyplot.xlim(window_time_arr[0],window_time_arr[-1])
# # ax2=pyplot.subplot(gs[1])
# # ax2.set_xlabel('Time(hour)',fontsize=15)
# # ax2.set_title('Instantaneous Phase',fontsize=15)
...
# # ax2.scatter(window_time_arr[12354],phase_whole_long[12354],c='k',s=40)
# # ax2.scatter(window_time_arr[13742],phase_whole_long[13742],c='k',s=40)
# # ax2.scatter(window_time_arr[18039],phase_whole_long[18039],c='k',s=40)
# # # ax2.scatter(window_time_arr[19526],phase_whole_long[19526],c='k',s=40)
# # # ax2.scatter(window_time_arr[27936],phase_whole_long[27936],c='k',s=40)
# # # ax2.scatter(window_time_arr[34984],phase_whole_long[34984],c='k',s=40)
# # ax2.set_xlabel('Time(hour)',fontsize=15)
# # locs, labels = pyplot.xticks(fontsize=15)
# # locs, labels = pyplot.yticks(fontsize=15)
# # pyplot.hlines(0,window_time_arr[240*6],window_time_arr[-1],'k','dashed')
...
# # pyplot.plot(window_time_arr,medium_rhythm_value_arr_4,'b',label='12 hour')
# # pyplot.plot(window_time_arr,long_rhythm_value_arr,'r',alpha=0.7,label='1 day')
# # pyplot.title('RRI autocorrelation in TAS0102',fontsize=15)
# # pyplot.xlabel('Time(hour)',fontsize=15)
# # pyplot.ylabel('Autocorrelation',fontsize=15)
# # pyplot.legend(loc='upper left',fontsize=10)
# # locs, labels = pyplot.xticks(fontsize=15)
...
# # gs = gridspec.GridSpec(2, 1, height_ratios=[3, 3])
# # ax1=pyplot.subplot(gs[0])
# # ax1.set_title('RRI autocorrelation in TAS0102',fontsize=15)
# # ax1.set_xlabel('Time(hour)',fontsize=15)
# # locs, labels = pyplot.xticks(fontsize=15)
# # locs, labels = pyplot.yticks(fontsize=15)
# # ax1.plot(window_time_arr[240*6:],long_rhythm_value_arr[240*6:],'orange',alpha=0.7)
# # # pyplot.xlim(window_time_arr[0],window_time_arr[-1])
# # ax1.scatter(window_time_arr[12354],long_rhythm_value_arr[12354],c='k',s=40)
# # ax1.scatter(window_time_arr[13742],long_rhythm_value_arr[13742],c='k',s=40)
# # ax1.scatter(window_time_arr[18039],long_rhythm_value_arr[18039],c='k',s=40)
# # # ax1.scatter(window_time_arr[19526],long_rhythm_value_arr[19526],c='k',s=40)
# # # ax1.scatter(window_time_arr[27936],long_rhythm_value_arr[27936],c='k',s=40)
# # # ax1.scatter(window_time_arr[34984],long_rhythm_value_arr[34984],c='k',s=40)
# # ax2=pyplot.subplot(gs[1])
# # ax2.set_title('Instantaneous Phase',fontsize=15)
# # ax2.set_xlabel('Time(hour)',fontsize=15)
# # locs, labels = pyplot.xticks(fontsize=15)
...
# # ax2.scatter(window_time_arr[12354],phase_whole_value_long[12354],c='k',s=40)
# # ax2.scatter(window_time_arr[13742],phase_whole_value_long[13742],c='k',s=40)
# # ax2.scatter(window_time_arr[18039],phase_whole_value_long[18039],c='k',s=40)
# # # ax2.scatter(window_time_arr[19526],phase_whole_value_long[19526],c='k',s=40)
# # # ax2.scatter(window_time_arr[27936],phase_whole_value_long[27936],c='k',s=40)
# # # ax2.scatter(window_time_arr[34984],phase_whole_value_long[34984],c='k',s=40)
# # ax2.set_xlabel('Time(hour)',fontsize=15)
# # locs, labels = pyplot.yticks([-0.5*np.pi,-0.25*np.pi,0,0.25*np.pi,0.5*np.pi],['-0.5$\pi$','Rising','0','Falling','0.5$\pi$'],rotation='vertical',fontsize=15)
# # pyplot.tight_layout()
# # pyplot.show()
...
# # a=np.where(t<11.2941667+0)
# # print(a)
# # print(t[2709]);print(t[2710])
# # t[0:2710]=t[0:2710]-0+12.7058333
# # t[2710:]=t[2710:]-11.2941667-0
# # print(t[2709]);print(t[2710]);
...
# #
# # seizure_time=[time_feature_arr[12354],time_feature_arr[13742],time_feature_arr[18039],time_feature_arr[19526],
# #               time_feature_arr[27936],time_feature_arr[34984],
# #               ]
# # print(seizure_time)
# # bins_number = 18
...
# # ax.set_title('seizure timing histogram (TAS0102)',fontsize=15)
# # ax.set_xticks(np.linspace(0, 2*np.pi, 24, endpoint=False))
# # ax.set_xticklabels(range(24))
# # pyplot.show()
# # seizure_time=[time_feature_arr[12354],time_feature_arr[13742],time_feature_arr[18039],
# #               # time_feature_arr[19526],
# #               # time_feature_arr[27936],time_feature_arr[34984],
# #               ]
# # print(seizure_time)
# # bins_number = 18
...
# # ax.annotate("", xy=(-1.799128834, 0.736345965), xytext=(0, 0),arrowprops=dict(arrowstyle="->",color='g',linewidth=2))
# # pyplot.show()
# #
# #
# # bins = np.linspace(0, 2*np.pi, bins_number + 1)
...
# #         pro_eegvars_time_false.append(0)
# #         pro_eegvars_time.append(0)
# # print(pro_eegvars_time[12354]);print(pro_eegvars_time[13742]);
# # print(pro_eegvars_time[18039]);
# # # print(pro_eegvars_time[19526]);
# # pro_eegautos_time = []
...
# #         pro_eegautos_time_false.append(5.14483E-05)
# #         pro_eegautos_time.append(0)
...
# #         pro_eegautos_time_false.append(0)
# #         pro_eegautos_time.append(0)
# # print(pro_eegautos_time[12354]);print(pro_eegautos_time[13742]);
# # print(pro_eegautos_time[18039]);
# # # print(pro_eegautos_time[19526]);
# # pro_RRIvars_time = []
...
# #         pro_RRIvars_time_false.append(0)
# #         pro_RRIvars_time.append(0)
# # print(pro_RRIvars_time[12354]);print(pro_RRIvars_time[13742]);
# # print(pro_RRIvars_time[18039]);
# # # print(pro_RRIvars_time[19526]);
# # pro_RRIautos_time = []
...
# #         pro_RRIautos_time_false.append(0)
# #         pro_RRIautos_time.append(0)
# # print(pro_RRIautos_time[12354]);print(pro_RRIautos_time[13742]);
# # print(pro_RRIautos_time[18039]);
# # # print(pro_RRIautos_time[19526]);
# #
# # Pseizureeegvar =0.000154321;
# # Pnonseizureeegvar = 0.999845679;
...
# # # Pcombined = []
# # # for m in range(len(pro_eegvars_time)):
# # #     P1=Pseizureeegvar*pro_eegvars_time[m]*pro_RRIautos_time[m]*pro_RRIvars_time[m]
# # #     P2=Pnonseizureeegvar*(1-pro_eegvars_time_false[m]*pro_RRIautos_time_false[m]*pro_RRIvars_time_false[m])
# # #     Pcombined.append(P1/(P1+P2))
# # Pcombined = []
# # for m in range(len(pro_eegvars_time)):
...
# # pyplot.title('combined probability in TAS0102', fontsize=15)
# # pyplot.annotate('', xy=(51.4819444, np.max(Pcombined)), xytext=(51.4819444, np.max(Pcombined) + 0.00000000001),arrowprops=dict(facecolor='black', shrink=0.05))
# # pyplot.annotate('', xy=(57.2641667, np.max(Pcombined)), xytext=(57.2641667, np.max(Pcombined) + 0.00000000001),arrowprops=dict(facecolor='black', shrink=0.05))
# # pyplot.annotate('', xy=(75.1694444, np.max(Pcombined)), xytext=(75.1694444, np.max(Pcombined) + 0.00000000001),arrowprops=dict(facecolor='black', shrink=0.05))
# # # pyplot.annotate('', xy=(81.3655556, np.max(Pcombined)), xytext=(81.3655556, np.max(Pcombined) + 0.00000000001),arrowprops=dict(facecolor='black', shrink=0.05))
# # pyplot.tight_layout()
...
# # print(a)
# # print(t[2709]);print(t[2710])
# # t[0:2709]=t[0:2709]-0+12.7058333
# # t[2710:]=t[2710:]-11.2941667-0
# # print(t[2709]);print(t[2710]);
# # print(type(t));print(t[0])
# # time_feature_arr=[]
...
# #         pro_circadian_time_false.append(0.049390338)
...
# #         pro_circadian_time_false.append(0.057159027)
# #         pro_circadian_time.append(0)
# #     elif time_feature_arr[i] >= bins[10] and time_feature_arr[i] < bins[11]:
# #         pro_circadian_time_false.append(0.065853784)
# #         pro_circadian_time.append(0)
# #     elif time_feature_arr[i] >= bins[11] and time_feature_arr[i] < bins[12]:
# #         pro_circadian_time_false.append(0.065802336)
...
# #         pro_circadian_time_false.append(0.053917786)
# #         pro_circadian_time.append(0.333333333)
# #     elif time_feature_arr[i] >= bins[17] and time_feature_arr[i] <= bins[18]:
# #         pro_circadian_time_false.append(0.049390338)
# #         pro_circadian_time.append(0)
# # print(pro_circadian_time[12354]);print(pro_circadian_time[13742]);
# # print(pro_circadian_time[18039]);print(pro_circadian_time[19526]);
# # # Pcombined=[]
# # # for m in range(len(pro_eegvars_time)):
...
# # # Pcombined=[]
# # # for m in range(len(pro_eegvars_time)):
# # #     P1=pro_eegvars_time[m]*pro_RRIautos_time[m]*Pseizureeegvar*pro_RRIvars_time[m]*pro_circadian_time[m]
# # #     P2=Pnonseizureeegvar*(1-pro_eegvars_time_false[m]*pro_RRIautos_time_false[m]*pro_RRIvars_time_false[m]*pro_circadian_time_false[m])
# # #     Pcombined.append(P1/(P1+P2))
# # Pcombined=[]
# # for m in range(len(pro_eegvars_time)):
...
# csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/TAS0102/forecast81hsignal_3hcycle_EEGvar_TAS0102.csv',sep=',',header=None)
...
# csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/TAS0102/forecast81hsignal_3hcycle_EEGauto_TAS0102.csv',sep=',',header=None)
...
#     pyplot.xlabel('Time(h)')
#     pyplot.plot(t_window_arr[240*6:(19440+240*k)], long_rhythm_var_arr[240*6:],'orange')
# csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/TAS0102/forecast81hsignal_3hcycle_RRIvar_TAS0102.csv', sep=',',header=None)
...
#     pyplot.xlabel('Time(h)')
#     pyplot.plot(t_window_arr[240*6:19440+240*k], long_rhythm_auto_arr[240*6:],'orange')
# csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/TAS0102/forecast81hsignal_3hcycle_RRIauto_TAS0102.csv',sep=',',header=None)
...
# RRI_timewindow_arr=t[0:479]
# Pcombined=Pcombined[0:479]
# pyplot.plot(RRI_timewindow_arr,Pcombined)
# pyplot.annotate('',xy=(81.3655556,np.max(Pcombined)),xytext=(81.3655556,np.max(Pcombined)+0.000000000001),arrowprops=dict(facecolor='k',shrink=0.05))
# pyplot.annotate('',xy=(116.407778,np.max(Pcombined)),xytext=(116.407778,np.max(Pcombined)+0.000000000001),arrowprops=dict(facecolor='r',shrink=0.05))
# pyplot.annotate('',xy=(145.771389,np.max(Pcombined)),xytext=(145.771389,np.max(Pcombined)+0.000000000001),arrowprops=dict(facecolor='k',shrink=0.05))
# pyplot.title('Forecast seizures in TAS0102')
# pyplot.xlabel('Time(h)')
# pyplot.ylabel('Seizure probability')
# # pyplot.hlines(1.906305364625543e-06, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'r')
# # pyplot.hlines(5.748948448671537e-06, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'r')
# pyplot.hlines(5.7103704854057186e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'r')
# # pyplot.hlines(0.6*5.7103704854057186e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# # pyplot.hlines(0.3*5.7103704854057186e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# # pyplot.hlines(1.2*5.7103704854057186e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# # pyplot.hlines(1.5*5.7103704854057186e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# pyplot.show()
...
# #         if item >= 5.7103704854057186e-05:
# #             index.append(6*i+0)
...
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 0.3*5.7103704854057186e-05:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 0.6*5.7103704854057186e-05:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 1.2*5.7103704854057186e-05:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 2*5.7103704854057186e-05:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# #     if j < 5.7103704854057186e-05:
# #         index.append(i)
# # print(RRI_timewindow_arr[index])
# # print(len(index))
# # time_arr=[81.3655556,116.407778,145.771389]
# # k=0
# # n_arr=[]
# # for m in time_arr:
...
# # index=[]
# # for i, j in enumerate(Pcombined):
# #     if j < 0.3*5.7103704854057186e-05:
# #         index.append(i)
# # print(RRI_timewindow_arr[index])
# # print(len(index))
# # time_arr=[81.3655556,116.407778,145.771389]
...
# # index=[]
# # for i, j in enumerate(Pcombined):
# #     if j < 0.6*5.7103704854057186e-05:
# #         index.append(i)
# # print(RRI_timewindow_arr[index])
# # print(len(index))
# # time_arr=[81.3655556,116.407778,145.771389]
...
# # index=[]
# # for i, j in enumerate(Pcombined):
# #     if j < 1.2*5.7103704854057186e-05:
# #         index.append(i)
# # print(RRI_timewindow_arr[index])
# # print(len(index))
# # time_arr=[81.3655556,116.407778,145.771389]
...
# print(AUC_cs_arr)
# print(time_arr_arr)
# np.savetxt("C:/Users/wxiong/PycharmProjects/EEGstudy/chance_predictor/AUC_EEG_ECG_6h_TAS0102.csv", AUC_cs_arr, delimiter=",", fmt='%s')
# np.savetxt("C:/Users/wxiong/PycharmProjects/EEGstudy/chance_predictor/seizure_labels_EEG_ECG_6h_TAS0102.csv", time_arr_arr, delimiter=",", fmt='%s')
#
#
# t1=np.linspace(0.00416667,0.00416667+0.00416667*(len(Raw_variance_EEG_arr)-1),len(Raw_variance_EEG_arr))
# a=np.where(t1<11.2941667+0)
# print(a)
# print(t1[2709]);print(t1[2710])
# t1[0:2710]=t1[0:2710]-0+12.7058333
# t1[2710:]=t1[2710:]-11.2941667-0
# print(t1[2709]);print(t1[2710]);
...
# pyplot.annotate('',xy=(81.3655556,np.max(pro_circadian_time)),xytext=(81.3655556,np.max(pro_circadian_time)+0.000000000001),arrowprops=dict(facecolor='k',shrink=0.05))
# pyplot.annotate('',xy=(116.407778,np.max(pro_circadian_time)),xytext=(116.407778,np.max(pro_circadian_time)+0.000000000001),arrowprops=dict(facecolor='r',shrink=0.05))
# pyplot.annotate('',xy=(145.771389,np.max(pro_circadian_time)),xytext=(145.771389,np.max(pro_circadian_time)+0.000000000001),arrowprops=dict(facecolor='r',shrink=0.05))
...
# pyplot.hlines(0.4, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# pyplot.title('Forecast seizures in TAS0102')
# pyplot.xlabel('Time(h)')
# pyplot.ylabel('Seizure probability')
# pyplot.show()
...
# np.savetxt("C:/Users/wxiong/PycharmProjects/EEGstudy/chance_predictor/AUC_circa6h_TAS0102.csv", AUC_com_arr_EEGcirca, delimiter=",", fmt='%s')
# np.savetxt("C:/Users/wxiong/PycharmProjects/EEGstudy/chance_predictor/seizure_labels_circa6h_TAS0102.csv", time_arr_arr_EEGcirca, delimiter=",", fmt='%s')
#
#
# Pseizureeegvar = 0.000154321;
# Pnonseizureeegvar = 0.999845679;
...
# pyplot.annotate('',xy=(81.3655556,np.max(Pcombined)),xytext=(81.3655556,np.max(Pcombined)+0.000000000001),arrowprops=dict(facecolor='k',shrink=0.05))
# pyplot.annotate('',xy=(116.407778,np.max(Pcombined)),xytext=(116.407778,np.max(Pcombined)+0.000000000001),arrowprops=dict(facecolor='r',shrink=0.05))
# pyplot.annotate('',xy=(145.771389,np.max(Pcombined)),xytext=(145.771389,np.max(Pcombined)+0.000000000001),arrowprops=dict(facecolor='r',shrink=0.05))
# pyplot.title('Forecast seizures in TAS0102')
# pyplot.xlabel('Time(h)')
# pyplot.ylabel('Seizure probability')
# # pyplot.hlines(6.351813782685079e-07, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'r')
# # pyplot.hlines(1.906197186044109e-06, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'r')
# pyplot.hlines(1.7241243013355946e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'r')
# # pyplot.hlines(0.6*1.7241243013355946e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# # pyplot.hlines(0.3*1.7241243013355946e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# # pyplot.hlines(1.2*1.7241243013355946e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# # pyplot.hlines(1.5*1.7241243013355946e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# pyplot.show()
# # Pcombined=split(Pcombined,6)
# # print(len(Pcombined))
# # index=[]
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 1.7241243013355946e-05:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 0.3*1.7241243013355946e-05:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 0.6*1.7241243013355946e-05:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 1.2*1.7241243013355946e-05:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# # index=[]
# # for i, j in enumerate(Pcombined):
# #     if j < 0.3*1.7241243013355946e-05:
# #         index.append(i)
# # print(RRI_timewindow_arr[index])
# # print(len(index))
# # time_arr=[81.3655556,116.407778,145.771389]
...
# # index=[]
# # for i, j in enumerate(Pcombined):
# #     if j < 0.6*1.7241243013355946e-05:
# #         index.append(i)
# # print(RRI_timewindow_arr[index])
# # print(len(index))
# # time_arr=[81.3655556,116.407778,145.771389]
...
# # index=[]
# # for i, j in enumerate(Pcombined):
# #     if j < 1.2*1.7241243013355946e-05:
# #         index.append(i)
# # print(RRI_timewindow_arr[index])
# # print(len(index))
# # time_arr=[81.3655556,116.407778,145.771389]
...
# print(AUC_com_arr_EEGcirca)
# print(time_arr_arr_EEGcirca)
# np.savetxt("C:/Users/wxiong/PycharmProjects/EEGstudy/chance_predictor/AUC_EEG_ECG_circa6h_TAS0102.csv", AUC_com_arr_EEGcirca, delimiter=",", fmt='%s')
# np.savetxt("C:/Users/wxiong/PycharmProjects/EEGstudy/chance_predictor/seizure_labels_EEG_ECGcirca6h_TAS0102.csv", time_arr_arr_EEGcirca, delimiter=",", fmt='%s')
