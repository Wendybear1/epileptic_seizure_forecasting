...
csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/VIC0685/Cz_EEGvariance_VIC0685_15s_3h.csv',
                         sep=',', header=None)
Raw_variance_EEG = csv_reader.values
csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/VIC0685/Cz_EEGauto_VIC0685_15s_3h.csv', sep=',',
                         header=None)
Raw_auto_EEG = csv_reader.values
csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/VIC0685/Cz_EEGauto_lag1_VIC0685_15s_3h.csv',
                         sep=',', header=None)
...
print(t_window_arr[0]);print(t_window_arr[-1]);print(len(t_window_arr));print(t_window_arr[19440]);
...
# pyplot.title('EEG variance in VIC0685',fontsize=13)
# pyplot.show()
var_arr = []
...
for k in range(len(window_time_arr)):
    if window_time_arr[k] < 1.622222 and window_time_arr[k + 1] >= 1.622222:
        seizure_timing_index.append(k)
    if window_time_arr[k] < 27.1838889 and window_time_arr[k + 1] >= 27.1838889:
        seizure_timing_index.append(k)
    if window_time_arr[k] < 43.7497222 and window_time_arr[k + 1] >= 43.7497222:
        seizure_timing_index.append(k)
    if window_time_arr[k] < 56.6475 and window_time_arr[k + 1] >= 56.6475:
        seizure_timing_index.append(k)
    if window_time_arr[k] < 65.0219444 and window_time_arr[k + 1] >= 65.0219444:
        seizure_timing_index.append(k)
    if window_time_arr[k] < 114.977778 and window_time_arr[k + 1] >= 114.977778:
        seizure_timing_index.append(k)
    if window_time_arr[k] < 141.566389 and window_time_arr[k + 1] >= 141.566389:
        seizure_timing_index.append(k)
    if window_time_arr[k] < 147.095278 and window_time_arr[k + 1] >= 147.095278:
        seizure_timing_index.append(k)
    if window_time_arr[k] < 150.362 and window_time_arr[k + 1] >= 150.362:
        seizure_timing_index.append(k)
...
seizure_timing_index = []
for k in range(len(window_time_arr)):
    if window_time_arr[k] < 115.715831 and window_time_arr[k + 1] >= 115.715831:
        seizure_timing_index.append(k)
print(seizure_timing_index)
index_cluster=seizure_timing_index

duration=[1,19,26,1,4,6,5,5,2]
...
np.savetxt("C:/Users/wxiong/Documents/PHD/combine_features/VIC0685_tags.csv", x, delimiter=",", fmt='%s')
...
# # pyplot.title('EEG variance in VIC0685',fontsize=15)
...
# # ax1.set_title('EEG variance in VIC0685', fontsize=15)
# # ax1.set_xlabel('Time(hour)', fontsize=15)
# # ax1.set_ylabel('Voltage ($\mathregular{v^2}$)', fontsize=15)
# # locs, labels = pyplot.xticks(fontsize=15)
# # locs, labels = pyplot.yticks(fontsize=15)
# # ax1.scatter(window_time_arr[6523], long_rhythm_var_arr[6523], s=40, c='k')
# # ax1.scatter(window_time_arr[10498], long_rhythm_var_arr[10498], s=40, c='k')
# # ax1.scatter(window_time_arr[13594], long_rhythm_var_arr[13594], s=40, c='k')
# # ax1.scatter(window_time_arr[15604], long_rhythm_var_arr[15604], s=40, c='k')
# # # ax1.scatter(window_time_arr[27593],long_rhythm_var_arr[27593],s=40,c='k')
# # # ax1.scatter(window_time_arr[33974],long_rhythm_var_arr[33974],s=40,c='k')
...
# # locs, labels = pyplot.xticks(fontsize=15)
# # locs, labels = pyplot.yticks(fontsize=15)
# # ax2.scatter(window_time_arr[6523], phase_long_EEGvariance_arr[6523], s=40, c='k')
# # ax2.scatter(window_time_arr[10498], phase_long_EEGvariance_arr[10498], s=40, c='k')
# # ax2.scatter(window_time_arr[13594], phase_long_EEGvariance_arr[13594], s=40, c='k')
# # ax2.scatter(window_time_arr[15604], phase_long_EEGvariance_arr[15604], s=40, c='k')
# # # ax2.scatter(window_time_arr[27593],phase_long_EEGvariance_arr[27593],s=40,c='k')
# # # ax2.scatter(window_time_arr[33974],phase_long_EEGvariance_arr[33974],s=40,c='k')
...
# # pyplot.xlabel('Time(hour)',fontsize=13)
# # pyplot.title('EEG autocorrelation in VIC0685',fontsize=13)
# # pyplot.show()
# value_arr = []
...
# # pyplot.title('EEG autocorrelation in VIC0685',fontsize=15)
# # pyplot.xlabel('Time(hour)',fontsize=15)
...
# # ax2.set_title('EEG autocorrelation in VIC0685', fontsize=15)
# # ax2.set_xlabel('Time(hour)', fontsize=15)
# # locs, labels = pyplot.xticks(fontsize=15)
# # locs, labels = pyplot.yticks(fontsize=15)
# # ax2.scatter(window_time_arr[6523], long_rhythm_value_arr[6523], s=50, c='k')
# # ax2.scatter(window_time_arr[10498], long_rhythm_value_arr[10498], s=40, c='k')
# # ax2.scatter(window_time_arr[13594], long_rhythm_value_arr[13594], s=50, c='k')
# # ax2.scatter(window_time_arr[15604], long_rhythm_value_arr[15604], s=50, c='k')
# # # ax2.scatter(window_time_arr[27593],long_rhythm_value_arr[27593],s=50,c='k')
# # # ax2.scatter(window_time_arr[33974],long_rhythm_value_arr[33974],s=40,c='k')
...
# # pyplot.hlines(0, window_time_arr[240 * 6], window_time_arr[-1], 'k', 'dashed')
# # ax3.scatter(window_time_arr[6523], phase_long_EEGauto_arr[6523], s=50, c='k')
# # ax3.scatter(window_time_arr[10498], phase_long_EEGauto_arr[10498], s=40, c='k')
# # ax3.scatter(window_time_arr[13594], phase_long_EEGauto_arr[13594], s=50, c='k')
# # ax3.scatter(window_time_arr[15604], phase_long_EEGauto_arr[15604], s=50, c='k')
# # # ax3.scatter(window_time_arr[27593],phase_long_EEGauto_arr[27593],s=50,c='k')
# # # ax3.scatter(window_time_arr[33974],phase_long_EEGauto_arr[33974],s=40,c='k')
# # ax3.set_xlabel('Time(hour)', fontsize=15)
# # locs, labels = pyplot.yticks([-0.5 * np.pi, -0.25 * np.pi, 0, 0.25 * np.pi, 0.5 * np.pi],
# #                              ['-0.5$\pi$', 'Rising', '0', 'Falling', '0.5$\pi$'], rotation='vertical', fontsize=15)
# # pyplot.tight_layout()
...
#
#
# csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/VIC0685/RRI_ch31_timewindowarr_VIC0685_15s_3h.csv', sep=',',
#     header=None)
# rri_t = csv_reader.values
# csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/VIC0685/RRI_ch31_rawvariance_VIC0685_15s_3h.csv',
#                          sep=',', header=None)
# RRI_var = csv_reader.values
# csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/VIC0685/RRI_ch31_rawauto_VIC0685_15s_3h.csv',
#                          sep=',', header=None)
...
# # pyplot.plot(window_time_arr,medium_rhythm_var_arr_4,'b',label='12 hour')
# # pyplot.plot(window_time_arr,long_rhythm_var_arr,'r',alpha=0.7,label='1 day')
# # pyplot.title('RRI variance in VIC0685',fontsize=15)
# # pyplot.xlabel('Time(hour)',fontsize=15)
...
# # ax1.set_title('RRI variance in VIC0685', fontsize=15)
# # ax1.set_xlabel('Time(hour)', fontsize=15)
# # ax1.set_ylabel('Second($\mathregular{s^2}$)', fontsize=15)
# # locs, labels = pyplot.xticks(fontsize=15)
# # locs, labels = pyplot.yticks(fontsize=15)
# # ax1.scatter(window_time_arr[6523], long_rhythm_var_arr[6523], c='k', s=40)
# # ax1.scatter(window_time_arr[10498], long_rhythm_var_arr[10498], c='k', s=40)
# # ax1.scatter(window_time_arr[13594], long_rhythm_var_arr[13594], c='k', s=40)
# # ax1.scatter(window_time_arr[15604], long_rhythm_var_arr[15604], c='k', s=40)
# # # ax1.scatter(window_time_arr[27593],long_rhythm_var_arr[27593],c='k',s=40)
# # # ax1.scatter(window_time_arr[33974],long_rhythm_var_arr[33974],c='k',s=40)
# # # pyplot.xlim(window_time_arr[0],window_time_arr[-1])
# # ax2 = pyplot.subplot(gs[1])
# # ax2.set_xlabel('Time(hour)', fontsize=15)
# # ax2.set_title('Instantaneous Phase', fontsize=15)
...
# # ax2.scatter(window_time_arr[6523], phase_whole_long[6523], c='k', s=40)
# # ax2.scatter(window_time_arr[10498], phase_whole_long[10498], c='k', s=40)
# # ax2.scatter(window_time_arr[13594], phase_whole_long[13594], c='k', s=40)
# # ax2.scatter(window_time_arr[15604], phase_whole_long[15604], c='k', s=40)
# # # ax2.scatter(window_time_arr[27593],phase_whole_long[27593],c='k',s=40)
# # # ax2.scatter(window_time_arr[33974],phase_whole_long[33974],c='k',s=40)
# # ax2.set_xlabel('Time(hour)', fontsize=15)
# # locs, labels = pyplot.xticks(fontsize=15)
# # locs, labels = pyplot.yticks(fontsize=15)
# # pyplot.hlines(0, window_time_arr[240 * 6], window_time_arr[-1], 'k', 'dashed')
...
# # pyplot.plot(window_time_arr,medium_rhythm_value_arr_4,'b',label='12 hour')
# # pyplot.plot(window_time_arr,long_rhythm_value_arr,'r',alpha=0.7,label='1 day')
# # pyplot.title('RRI autocorrelation in VIC0685',fontsize=15)
# # pyplot.xlabel('Time(hour)',fontsize=15)
# # pyplot.ylabel('Autocorrelation',fontsize=15)
# # pyplot.legend(loc='upper left',fontsize=10)
# # locs, labels = pyplot.xticks(fontsize=15)
...
# # gs = gridspec.GridSpec(2, 1, height_ratios=[3, 3])
# # ax1 = pyplot.subplot(gs[0])
# # ax1.set_title('RRI autocorrelation in VIC0685', fontsize=15)
# # ax1.set_xlabel('Time(hour)', fontsize=15)
# # locs, labels = pyplot.xticks(fontsize=15)
# # locs, labels = pyplot.yticks(fontsize=15)
# # ax1.plot(window_time_arr[240 * 6:], long_rhythm_value_arr[240 * 6:], 'orange', alpha=0.7)
# # ax1.scatter(window_time_arr[6523], long_rhythm_value_arr[6523], c='k', s=40)
# # ax1.scatter(window_time_arr[10498], long_rhythm_value_arr[10498], c='k', s=40)
# # ax1.scatter(window_time_arr[13594], long_rhythm_value_arr[13594], c='k', s=40)
# # ax1.scatter(window_time_arr[15604], long_rhythm_value_arr[15604], c='k', s=40)
# # # ax1.scatter(window_time_arr[27593],long_rhythm_value_arr[27593],c='k',s=40)
# # # ax1.scatter(window_time_arr[33974],long_rhythm_value_arr[33974],c='k',s=40)
# # ax2 = pyplot.subplot(gs[1])
# # ax2.set_title('Instantaneous Phase', fontsize=15)
# # ax2.set_xlabel('Time(hour)', fontsize=15)
# # locs, labels = pyplot.xticks(fontsize=15)
...
# # ax2.scatter(window_time_arr[6523], phase_whole_value_long[6523], c='k', s=40)
# # ax2.scatter(window_time_arr[10498], phase_whole_value_long[10498], c='k', s=40)
# # ax2.scatter(window_time_arr[13594], phase_whole_value_long[13594], c='k', s=40)
# # ax2.scatter(window_time_arr[15604], phase_whole_value_long[15604], c='k', s=40)
# # # ax2.scatter(window_time_arr[27593],phase_whole_value_long[27593],c='k',s=40)
# # # ax2.scatter(window_time_arr[33974],phase_whole_value_long[33974],c='k',s=40)
# # ax2.set_xlabel('Time(hour)', fontsize=15)
# # locs, labels = pyplot.yticks([-0.5 * np.pi, -0.25 * np.pi, 0, 0.25 * np.pi, 0.5 * np.pi],
# #                              ['-0.5$\pi$', 'Rising', '0', 'Falling', '0.5$\pi$'], rotation='vertical', fontsize=15)
# # pyplot.tight_layout()
...
# # a=np.where(t<10.9663889+0)
# # print(a)
# # print(t[2630]);print(t[2631])
# # t[0:2631]=t[0:2631]-0+13.0336111
# # t[2631:]=t[2631:]-10.9663889-0
# # print(t[2630]);print(t[2631]);
...
# #
# # seizure_time=[time_feature_arr[6523],time_feature_arr[10498],time_feature_arr[13594],time_feature_arr[15604],
# #               time_feature_arr[27593],time_feature_arr[33974],
# #               ]
# # print(seizure_time)
# # bins_number = 18
...
# # ax.set_title('seizure timing histogram (VIC0685)',fontsize=15)
...
# # ax.annotate("", xy=(1.745329244, 0.086824089), xytext=(0, 0),arrowprops=dict(arrowstyle="->",color='g',linewidth=2))
# # pyplot.show()
# #
# # bins = np.linspace(0, 2*np.pi, bins_number + 1)
# # width = 2*np.pi / bins_number
...
# # #         pro_eegvars_time_false.append(0)
# # #         pro_eegvars_time.append(0)
# # # print(pro_eegvars_time[6523]);print(pro_eegvars_time[10498]);
# # # print(pro_eegvars_time[13594]);print(pro_eegvars_time[15604]);
# # # pro_eegautos_time = []
...
# # #         pro_eegautos_time_false.append(0)
# # #         pro_eegautos_time.append(0)
# # # print(pro_eegautos_time[6523]);print(pro_eegautos_time[10498]);
# # # print(pro_eegautos_time[13594]);print(pro_eegautos_time[15604]);
# # # pro_RRIvars_time = []
...
# # #         pro_RRIvars_time_false.append(0)
# # #         pro_RRIvars_time.append(0)
# # # print(pro_RRIvars_time[6523]);print(pro_RRIvars_time[10498]);
# # # print(pro_RRIvars_time[13594]);print(pro_RRIvars_time[15604]);
# # # pro_RRIautos_time = []
...
# # #         pro_RRIautos_time_false.append(0)
# # #         pro_RRIautos_time.append(0)
# # # print(pro_RRIautos_time[6523]);print(pro_RRIautos_time[10498]);
# # # print(pro_RRIautos_time[13594]);print(pro_RRIautos_time[15604]);
# # #
# # # Pseizureeegvar =0.000205761;
# # # Pnonseizureeegvar = 0.999794239;
...
# # # pyplot.title('combined probability in VIc0685', fontsize=15)
# # # pyplot.annotate('', xy=(27.1838889, np.max(Pcombined)), xytext=(27.1838889, np.max(Pcombined) + 0.00000000001),arrowprops=dict(facecolor='black', shrink=0.05))
# # # pyplot.annotate('', xy=(43.7497222, np.max(Pcombined)), xytext=(43.7497222, np.max(Pcombined) + 0.00000000001),arrowprops=dict(facecolor='black', shrink=0.05))
# # # pyplot.annotate('', xy=(56.6475, np.max(Pcombined)), xytext=(56.6475, np.max(Pcombined) + 0.00000000001),arrowprops=dict(facecolor='black', shrink=0.05))
# # # pyplot.annotate('', xy=(65.0219444, np.max(Pcombined)), xytext=(65.0219444, np.max(Pcombined) + 0.00000000001),arrowprops=dict(facecolor='black', shrink=0.05))
# # # pyplot.tight_layout()
# # # # pyplot.hlines(7.752587054009701e-07, window_time_arr[0],window_time_arr[-1],'r')
...
# # #         pro_circadian_time_false.append(0.049392879)
...
# # #         pro_circadian_time_false.append(0.049341428)
...
# # #         pro_circadian_time_false.append(0.053045894)
# # #         pro_circadian_time.append(0)
# # #     elif time_feature_arr[i] >= bins[10] and time_feature_arr[i] < bins[11]:
# # #         pro_circadian_time_false.append(0.065857172)
# # #         pro_circadian_time.append(0)
...
# # #         pro_circadian_time_false.append(0.065805721)
# # #         pro_circadian_time.append(0.25)
...
# # #         pro_circadian_time_false.append(0.058036633)
# # #         pro_circadian_time.append(0.25)
# # #     elif time_feature_arr[i] >= bins[17] and time_feature_arr[i] <= bins[18]:
# # #         pro_circadian_time_false.append(0.049392879)
# # #         pro_circadian_time.append(0)
# # # print(pro_circadian_time[6523]);print(pro_circadian_time[10498]);
# # # print(pro_circadian_time[13594]);print(pro_circadian_time[15604]);
# # #
# # # # Pcombined=[]
# # # # for m in range(len(pro_eegvars_time)):
# # # #     P1=pro_eegautos_time[m]*pro_RRIautos_time[m]*Pseizureeegvar*pro_RRIvars_time[m]*pro_circadian_time[m]
# # # #     P2=Pnonseizureeegvar*(1-pro_eegautos_time_false[m]*pro_RRIautos_time_false[m]*pro_RRIvars_time_false[m]*pro_circadian_time_false[m])
# # # #     Pcombined.append(P1/(P1+P2))
# # #
# # # # Pcombined=[]
# # # # for m in range(len(pro_eegvars_time)):
...
# # # Pcombined=[]
# # # for m in range(len(pro_eegvars_time)):
# # #     P1=pro_RRIvars_time[m]*pro_RRIautos_time[m]*Pseizureeegvar*pro_circadian_time[m]
...
# # # pyplot.tight_layout()
# # # pyplot.xlim(window_time_arr[0], window_time_arr[-1])
# # # # pyplot.hlines(1.9380197834107526e-07, window_time_arr[0],window_time_arr[-1],'r')
...
# csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/VIC0685/forecast81hsignal_3hcycle_EEGvar_VIC0685.csv',sep=',',header=None)
...
# csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/VIC0685/forecast81hsignal_3hcycle_EEGauto_VIC0685.csv',sep=',',header=None)
...
#     pyplot.xlabel('Time(h)')
#     pyplot.plot(t_window_arr[240*6:38877], long_rhythm_var_arr[240*6:],'orange')
# csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/VIC0685/forecast81hsignal_3hcycle_RRIvar_VIC0685.csv', sep=',',header=None)
...
#     pyplot.xlabel('Time(h)')
#     pyplot.plot(t_window_arr[240*6:38877], long_rhythm_auto_arr[240*6:],'orange')
# csv_reader = pd.read_csv('C:/Users/wxiong/Documents/PHD/2020.September/VIC0685/forecast81hsignal_3hcycle_RRIauto_VIC0685.csv',sep=',',header=None)
...
# Pcombined=[]
# for m in range(len(pro_eegvars_time)):
#     P1=Pseizureeegvar*pro_eegautos_time[m]*pro_RRIautos_time[m]*pro_RRIvars_time[m]
#     P2=Pnonseizureeegvar*(1-pro_eegautos_time_false[m]*pro_RRIautos_time_false[m]*pro_RRIvars_time_false[m])
#     Pcombined.append(P1/(P1+P2))
# print(len(Pcombined))
#
# # Pcombined=[]
...
# # Pcombined=[]
# # for m in range(len(pro_eegvars_time)):
# #     P1=Pseizureeegvar*pro_RRIautos_time[m]*pro_RRIvars_time[m]
...
# pyplot.annotate('',xy=(114.977778,np.max(Pcombined)),xytext=(114.977778,np.max(Pcombined)+0.000000000001),arrowprops=dict(facecolor='k',shrink=0.05))
# pyplot.annotate('',xy=(141.566389,np.max(Pcombined)),xytext=(141.566389,np.max(Pcombined)+0.000000000001),arrowprops=dict(facecolor='k',shrink=0.05))
# pyplot.annotate('',xy=(115.715831,np.max(Pcombined)),xytext=(115.715831,np.max(Pcombined)+0.000000000001),arrowprops=dict(facecolor='grey',shrink=0.05))
# pyplot.annotate('',xy=(147.095278,np.max(Pcombined)),xytext=(147.095278,np.max(Pcombined)+0.000000000001),arrowprops=dict(facecolor='grey',shrink=0.05))
# pyplot.annotate('',xy=(150.362,np.max(Pcombined)),xytext=(150.362,np.max(Pcombined)+0.000000000001),arrowprops=dict(facecolor='grey',shrink=0.05))
# pyplot.title('Forecast seizures in VIC0685')
# pyplot.xlabel('Time(h)')
# pyplot.ylabel('Seizure probability')
# pyplot.hlines(1.297026428950147e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'r')
# # pyplot.hlines(0.00017522314011752247, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'r')
# # pyplot.hlines(2.6252882183910712e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'r')
# # pyplot.hlines(0.6*1.297026428950147e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# # pyplot.hlines(0.3*1.297026428950147e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# # pyplot.hlines(1.2*1.297026428950147e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# # pyplot.hlines(1.5*1.297026428950147e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# pyplot.show()
#
...
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 0.3*1.297026428950147e-05:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 0.6*1.297026428950147e-05:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 1.2*1.297026428950147e-05:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 2*1.297026428950147e-05:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# #     if j < 1.297026428950147e-05:
# #         index.append(i)
# # print(RRI_timewindow_arr[index])
# # print(len(index))
# # time_arr=[114.977778,141.566389]
# # k=0
# # n_arr=[]
# # for m in time_arr:
...
# # index=[]
# # for i, j in enumerate(Pcombined):
# #     if j < 0.3*1.297026428950147e-05:
# #         index.append(i)
# # print(RRI_timewindow_arr[index])
# # print(len(index))
# # time_arr=[114.977778,141.566389]
...
# # index=[]
# # for i, j in enumerate(Pcombined):
# #     if j < 0.6*1.297026428950147e-05:
# #         index.append(i)
# # print(RRI_timewindow_arr[index])
# # print(len(index))
# # time_arr=[114.977778,141.566389]
...
# # index=[]
# # for i, j in enumerate(Pcombined):
# #     if j < 1.2*1.297026428950147e-05:
# #         index.append(i)
# # print(RRI_timewindow_arr[index])
# # print(len(index))
# # time_arr=[114.977778,141.566389]
...
# print(AUC_cs_arr)
# print(time_arr_arr)
# np.savetxt("C:/Users/wxiong/PycharmProjects/EEGstudy/chance_predictor/AUC_EEG_ECG_6h_VIC0685.csv", AUC_cs_arr, delimiter=",", fmt='%s')
# np.savetxt("C:/Users/wxiong/PycharmProjects/EEGstudy/chance_predictor/seizure_labels_EEG_ECG_6h_VIC0685.csv", time_arr_arr, delimiter=",", fmt='%s')
#
#
# #### add circadian
# t1=np.linspace(0.00416667,0.00416667+0.00416667*(len(Raw_variance_EEG_arr)-1),len(Raw_variance_EEG_arr))
# a=np.where(t1<10.9663889+0)
# print(a)
# print(t1[2630]);print(t1[2631])
# t1[0:2631]=t1[0:2631]-0+13.0336111
# t1[2631:]=t1[2631:]-10.9663889-0
# print(t1[2630]);print(t1[2631]);
...
# # pyplot.annotate('',xy=(114.977778,np.max(pro_circadian_time)),xytext=(114.977778,np.max(pro_circadian_time)+0.000000000001),arrowprops=dict(facecolor='r',shrink=0.05))
# # pyplot.annotate('',xy=(141.566389,np.max(pro_circadian_time)),xytext=(141.566389,np.max(pro_circadian_time)+0.000000000001),arrowprops=dict(facecolor='r',shrink=0.05))
...
# np.savetxt("C:/Users/wxiong/PycharmProjects/EEGstudy/chance_predictor/AUC_circa6h_VIC0685.csv", AUC_com_arr_EEGcirca, delimiter=",", fmt='%s')
# np.savetxt("C:/Users/wxiong/PycharmProjects/EEGstudy/chance_predictor/seizure_labels_circa6h_VIC0685.csv", time_arr_arr_EEGcirca, delimiter=",", fmt='%s')
#
#
# Pseizureeegvar =0.000205761;
# Pnonseizureeegvar = 0.999794239;
...
# # Pcombined=[]
# # for m in range(len(pro_circadian_time)):
# #     P1=pro_RRIautos_time[m]*Pseizureeegvar*pro_RRIvars_time[m]*pro_circadian_time[m]
# #     P2=Pnonseizureeegvar*(1-pro_RRIautos_time_false[m]*pro_RRIvars_time_false[m]*pro_circadian_time_false[m])
# #     Pcombined.append(P1/(P1+P2))
# # print(len(Pcombined))
#
# pyplot.figure(figsize=(8,4))
# RRI_timewindow_arr=t[0:len(pro_circadian_time)]
# pyplot.plot(RRI_timewindow_arr,Pcombined)
# pyplot.annotate('',xy=(114.977778,np.max(Pcombined)),xytext=(114.977778,np.max(Pcombined)+0.000000000001),arrowprops=dict(facecolor='r',shrink=0.05))
# pyplot.annotate('',xy=(141.566389,np.max(Pcombined)),xytext=(141.566389,np.max(Pcombined)+0.000000000001),arrowprops=dict(facecolor='r',shrink=0.05))
# pyplot.title('Forecast seizures in VIC0685')
# pyplot.xlabel('Time(h)')
# pyplot.ylabel('Seizure probability')
# pyplot.hlines(3.216985247339675e-06, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'r')
# # pyplot.hlines(2.625965778402741e-05, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'r')
# # pyplot.hlines(6.43770336423342e-06, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'r')
# # pyplot.hlines(0.6*3.216985247339675e-06, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# # pyplot.hlines(0.3*3.216985247339675e-06, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# # pyplot.hlines(1.2*3.216985247339675e-06, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# # pyplot.hlines(1.5*3.216985247339675e-06, RRI_timewindow_arr[0],RRI_timewindow_arr[-1],'orange')
# pyplot.show()
#
# # Pcombined=split(Pcombined,6)
# # print(len(Pcombined))
...
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 0.3*3.216985247339675e-06:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 0.6*3.216985247339675e-06:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 1.2*3.216985247339675e-06:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# # for i in range(len(Pcombined)):
# #     for item in Pcombined[i]:
# #         if item >= 2*1.7241243013355946e-05:
# #             index.append(6*i+0)
# # print(RRI_timewindow_arr[index])
# # a=np.unique(RRI_timewindow_arr[index])
# # print(a); print(len(a))
...
# # index=[]
# # for i, j in enumerate(Pcombined):
# #     if j < 0.3*3.216985247339675e-06:
# #         index.append(i)
# # print(RRI_timewindow_arr[index])
# # print(len(index))
# # time_arr=[114.977778,141.566389]
...
# # index=[]
# # for i, j in enumerate(Pcombined):
# #     if j < 0.6*3.216985247339675e-06:
# #         index.append(i)
# # print(RRI_timewindow_arr[index])
# # print(len(index))
# # time_arr=[114.977778,141.566389]
...
# # index=[]
# # for i, j in enumerate(Pcombined):
# #     if j < 1.2*3.216985247339675e-06:
# #         index.append(i)
# # print(RRI_timewindow_arr[index])
# # print(len(index))
# # time_arr=[114.977778,141.566389]
...
# print(AUC_com_arr_EEGcirca)
# print(time_arr_arr_EEGcirca)
# np.savetxt("C:/Users/wxiong/PycharmProjects/EEGstudy/chance_predictor/AUC_EEG_ECG_circa6h_VIC0685.csv", AUC_com_arr_EEGcirca, delimiter=",", fmt='%s')
# np.savetxt("C:/Users/wxiong/PycharmProjects/EEGstudy/chance_predictor/seizure_labels_EEG_ECGcirca6h_VIC0685.csv", time_arr_arr_EEGcirca, delimiter=",", fmt='%s')
